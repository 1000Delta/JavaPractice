...
public static void main (String[] args) {
	...
	String paramString = "1234567890123456789012345678901234";
	boolean bool1 = false;
    boolean bool2;
    ...
    for (;;)
    {
      ...
      for (j = 0;; j++)
      {
        ...
        bool2 = bool1;
        if (a[j] != b[j] * arrayOfInt[j] * arrayOfInt[j] + c[j] * arrayOfInt[j] + d[j]) {
          break;
        }
        bool2 = bool1;
        if (a[(j + 1)] != b[j] * arrayOfInt[(j + 1)] * arrayOfInt[(j + 1)] + c[j] * arrayOfInt[(j + 1)] + d[j]) {
          break;
        }
      }
      label185:
